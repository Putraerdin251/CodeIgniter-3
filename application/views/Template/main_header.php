				...
				<div class="container-fluid main-container ">
					<div class="main-header-left ">
						...
						<div class="responsive-logo">
							<a href="index.html" class="header-logo"><img src="<?php echo base_url()?>assets/img/brand/logo.png" class="logo-11"></a>
							<a href="index.html" class="header-logo"><img src="<?php echo base_url()?>assets/img/brand/logo-white.png" class="logo-1"></a>
						</div>
										...
										<div class="dropdown-menu">
											...
											<div class="main-message-list chat-scroll">
												<a href="mail.html" class="p-3 d-flex border-bottom">
													<div class="drop-img  cover-image  " data-bs-image-src="<?php echo base_url()?>assets/img/faces/3.jpg">
												...
												<a href="mail.html" class="p-3 d-flex border-bottom">
													<div class="drop-img cover-image" data-bs-image-src="<?php echo base_url()?>assets/img/faces/2.jpg">
														<span class="avatar-status bg-teal"></span>
													</div>
													<div class="wd-90p">
														<div class="d-flex">
												...
												<a href="mail.html" class="p-3 d-flex border-bottom">
													<div class="drop-img cover-image" data-bs-image-src="<?php echo base_url()?>assets/img/faces/9.jpg">
														<span class="avatar-status bg-teal"></span>
													</div>
													<div class="wd-90p">
														<div class="d-flex">
												...
												<a href="mail.html" class="p-3 d-flex border-bottom">
													<div class="drop-img cover-image" data-bs-image-src="<?php echo base_url()?>assets/img/faces/12.jpg">
												...
												<a href="mail.html" class="p-3 d-flex border-bottom">
													<div class="drop-img cover-image" data-bs-image-src="<?php echo base_url()?>assets/img/faces/5.jpg">
														<span class="avatar-status bg-teal"></span>
													</div>
													<div class="wd-90p">
														<div class="d-flex">
